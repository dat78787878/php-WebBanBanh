            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="your-order">
                                        ...
                                        <div class="cart-item">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <span class="cart-item-amount color-gray your-order-info">Số lượng {{$product['qty']}}</span>
                        ...
                        <div class="text-center"><button type="submit" class="beta-btn primary" href="#">Đặt hàng <i class="fa fa-chevron-right"></i></div>
                    </div> <!-- .your-order -->
                </div>
            </div>
        </form>
